...
public class SafariFlavorsFoodItemAdapter extends RecyclerView.Adapter<SafariFlavorsFoodItemAdapter.FoodItemViewHolder> {

    private List<SafariFlavorsFoodItem> foodItemList;
    private SafariFlavorsFoodItemRecycler activity;

    public SafariFlavorsFoodItemAdapter(List<SafariFlavorsFoodItem> foodItemList, SafariFlavorsFoodItemRecycler activity) {
    ...
    public void onBindViewHolder(@NonNull FoodItemViewHolder holder, int position) {
        SafariFlavorsFoodItem foodItem = foodItemList.get(position);
