...
import com.joshuajacobs.sudentfoodapp.adapters.CartListAdapter;
import com.joshuajacobs.sudentfoodapp.databinding.FragmentCartBinding;
...
public class CartFragment extends Fragment implements CartListAdapter.CartInterface {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        cartTotalAmount = fragmentCartBinding.orderTotalTextView;

        // In the first fragment
        String originalString = cartTotalAmount.getText().toString();
        ...
        shopViewModel.getTotalPrice().observe(getViewLifecycleOwner(), new Observer<Double>() {
            ...
            public void onChanged(Double aDouble) {
                ...
                bundle.putString("stringValue", aDouble.toString().trim());
            }
        });
